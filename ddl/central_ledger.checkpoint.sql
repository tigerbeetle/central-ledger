...
--
-- Table structure for table `tigerBeetleAccountSpec`
--

DROP TABLE IF EXISTS `tigerBeetleAccountSpec`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tigerBeetleAccountSpec` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `tigerBeetleAccountSpec_dfspid_currency_istombstoned_unique` (`dfspId`,`currency`,`isTombstoned`),
  KEY `tigerBeetleAccountSpec_dfspid_index` (`dfspId`),
  KEY `tigerBeetleAccountSpec_currency_index` (`currency`),
  KEY `tigerBeetleAccountSpec_dfspid_currency_index` (`dfspId`,`currency`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tigerBeetleAccountSpec`
--

LOCK TABLES `tigerBeetleAccountSpec` WRITE;
/*!40000 ALTER TABLE `tigerBeetleAccountSpec` DISABLE KEYS */;
/*!40000 ALTER TABLE `tigerBeetleAccountSpec` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tigerBeetleTransferSpec`
--

DROP TABLE IF EXISTS `tigerBeetleTransferSpec`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tigerBeetleTransferSpec` (
...
--
-- Dumping data for table `tigerBeetleTransferSpec`
--

LOCK TABLES `tigerBeetleTransferSpec` WRITE;
/*!40000 ALTER TABLE `tigerBeetleTransferSpec` DISABLE KEYS */;
/*!40000 ALTER TABLE `tigerBeetleTransferSpec` ENABLE KEYS */;
UNLOCK TABLES;
