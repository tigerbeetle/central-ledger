...
export class LedgerSql implements Ledger {
  ...
  public async withdrawPrepare(cmd: WithdrawPrepareCommand): Promise<WithdrawPrepareResponse> {
    ...
    try {
      ...
      // // Backwards compatibiltity: create participantPosition and activate SETTLEMENT account.
      ...
      // // Backwards compatibiltity: create participantPosition and activate POSITION account.
      ...
      // const validationResult = await Participant.recordFundsInOut(
      //   payload,
