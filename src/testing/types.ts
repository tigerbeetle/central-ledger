...
/**
 * Mapping between legacy test file and its expected new location
 */
export interface MigrationMapping {
  /** Path to the legacy test file (e.g., test/unit/foo.test.js) */
  legacyFile: string
  /** Expected path for the migrated test (e.g., src/foo.unit.ts) */
...
/**
 * Summary report of the test migration progress
 */
export interface MigrationReport {
  /** Total number of legacy test files */
  totalLegacyFiles: number
  /** Number of files that have been migrated */
  totalMigratedFiles: number
  /** Percentage of files migrated (0-100) */
  percentFileMigrated: number
  /** Total number of tests in legacy files */
  legacyTestCount: number
  /** Total number of tests in new native test files */
  newTestCount: number
}
