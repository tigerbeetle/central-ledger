...
import { MySqlProxyCacheConfig, ProxyCacheConfig, RedisClusterProxyCacheConfig, RedisProxyCacheConfig } from '@mojaloop/inter-scheme-proxy-cache-lib'
...
export function assertNestedFields(rawConfig: any, path: string): void {
  // path could be simply DATABASE, or could be HANDLERS.API
